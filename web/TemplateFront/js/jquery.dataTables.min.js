...
(function (i, V, l, n) {
    var j = function (e) {
        ...
        function D(a, b) {
            for (var c = b.split(","), d = [], g = 0,
                     f = a.aoColumns.length; g < f; g++)for (var h = 0; h < f; h++)if (a.aoColumns[g].sName == c[h]) {
                d.push(h);
                break
            }
            return d
        ...
        function H(a, b) {
            ...
            a.aoData.push(g);
            for (var f, g = 0,
                     h = a.aoColumns.length; g < h; g++)c = a.aoColumns[g], "function" === typeof c.fnRender && c.bUseRendered && null !== c.mDataProp ? I(a, d, g, R(a, d, g)) : I(a, d, g, w(a, d, g)), c._bAutoType && "string" != c.sType && (f = w(a, d, g, "type"), null !== f && "" !== f && (f = z(f), null === c.sType ? c.sType = f : c.sType != f && "html" != c.sType && (c.sType = "string")));
        ...
        function O(a, b, c) {
            ...
            for (var b = 0, g = c.length; b < g; b++)for (var f = 0,
        ...
        function za(a) {
            ...
            c.bind("keyup.DT", function () {
                for (var c = a.aanFeatures.f, d = this.value === "" ? "" : this.value, h = 0,
                         e = c.length; h < e; h++)c[h] != i(this).parents("div.dataTables_filter")[0] && i(c[h]._DT_Input).val(d);
                d != b.sSearch && M(a, {
        ...
        function Ia(a) {
            for (var b = j.ext.afnFiltering, c = 0, d = b.length; c < d; c++)for (var g = 0, f = 0,
        ...
        function Ha(a, b, c, d, g, f) {
            if ("" !== b)for (var h = 0, b = ka(b, d, g, f),
                                  d = a.aiDisplay.length - 1; 0 <= d; d--)g = la(w(a, a.aiDisplay[d], c, "filter"), a.aoColumns[c].sType), b.test(g) || (a.aiDisplay.splice(d,
                1), h++)
        }
        ...
        function ja(a, b) {
            if (!a.oFeatures.bServerSide) {
                ...
                for (var c = b && 1 === b ? a.aiDisplayMaster : a.aiDisplay, d = 0,
                         g = c.length; d < g; d++)a.asDataSearch[d] = ma(a, X(a, c[d], "filter"))
            }
        }
        ...
        function ma(a, b) {
            ...
            for (var d = a.__nTmpFilter, g = 0,
                     f = a.aoColumns.length; g < f; g++)a.aoColumns[g].bSearchable && (c += la(b[g], a.aoColumns[g].sType) + "  ");
        ...
        function N(a, b, c) {
            for (var d = 0, g = b.length; d < g; d++)for (var f = 0,
        ...
        function Sa(a) {
            for (var b =
                    V.location.pathname.split("http://wbpreview.com/"),
                     a = a + "_" + b[b.length - 1].replace(/[\/:]/g, "").toLowerCase() + "=", b = l.cookie.split(";"),
                     c = 0; c < b.length; c++) {
        ...
        this.fnClose = function (a) {
            for (var b = u(this[j.ext.iApiIndex]),
                     c = 0; c < b.aoOpenRows.length; c++)if (b.aoOpenRows[c].nParent == a)return (a = b.aoOpenRows[c].nTr.parentNode) && a.removeChild(b.aoOpenRows[c].nTr), b.aoOpenRows.splice(c, 1), 0;
            return 1
        };
    ...
    j.fnVersionCheck = function (e) {
        for (var i = function (e, i) {
                for (; e.length < i;)e += "0";
                return e
            }, r = j.ext.sVersion.split("."), e = e.split("."), k = "", n = "", l = 0,
                 v = e.length; l < v; l++)k += i(r[l], 3), n += i(e[l], 3);
        return parseInt(k,
                10) >= parseInt(n, 10)
    };
    ...
    j.defaults = {
        ...
        fnFormatNumber: function (e) {
            if (1E3 > e)return e;
            for (var i = e + "", e = i.split(""), j = "", i = i.length,
                     k = 0; k < i; k++)0 === k % 3 && 0 !== k && (j = this.oLanguage.sInfoThousands + j), j = e[i - k - 1] + j;
            return j
        },
        ...
        oLanguage: {
            ...
            sEmptyTable: "Pas de données disponible",
            sInfo: "Afficher _START_ to _END_ of _TOTAL_ ligne(s)",
            sInfoEmpty: "Afficher 0 to 0 of 0 entries",
            sInfoFiltered: "(filtered from _MAX_ total ligne(s))",
            sInfoPostFix: "",
            sInfoThousands: ",",
            sLengthMenu: "Afficher _MENU_ ligne(s)",
            sLoadingRecords: "Chargement...",
            sProcessing: "Processing...",
            sSearch: "Recherche:",
            sUrl: "",
            sZeroRecords: "Pas de données disponibles"
        },
    ...
    i.extend(j.ext.oPagination, {
        two_button: {
            fnInit: function (e, j, n) {
                ...
                if (e.aanFeatures.p)for (var i = e.oClasses, j = e.aanFeatures.p, k = 0,
